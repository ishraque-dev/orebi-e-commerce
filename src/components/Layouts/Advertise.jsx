...
function Advertise() {
  return (
    <div className=" mx-auto -mt-[170px] flex max-w-container gap-x-3 py-14 md:gap-8">
      <div className="flex w-1/2 flex-wrap items-start justify-start bg-white  ">
        <div className=" ml-7 flex w-[81%] justify-between bg-[#FEBD69] p-2 md:ml-14">
          <div>
            <h3 className="font-regular  inline-block animate-blinkingText font-dm text-xl text-black ">
              Todays Hot Deals
            </h3>
          </div>
          <Marquee
